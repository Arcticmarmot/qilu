...
public class PostLikeController {
    ...
    public ApiResponse<Void> likePost(@Parameter(description = "帖子ID") @PathVariable Long postId) {
    ...
    public ApiResponse<Void> unlikePost(@Parameter(description = "帖子ID") @PathVariable Long postId) {
