CREATE TABLE `reply_notification` (
                                        ...
                                        `creation_type` VARCHAR(32) NOT NULL COMMENT '关联创作类型：POST、COMMENT',
                                        `creation_id` BIGINT NOT NULL COMMENT '关联创作ID',
                                        `creation_snippet` VARCHAR(255) NOT NULL COMMENT '关联创作预览',
                                        `content_snippet` VARCHAR(255) NOT NULL COMMENT '回复内容预览',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='回复通知表';